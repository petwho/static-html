            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu hidden-xs">
                        ...
                        <li><a href="./product.php#olive-collagen" class="text-center" style="margin-left: 15px;">Olive Collagen</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu hidden-xs">
                        ...
                        <li><a href="./distribution.php#olive-collagen" class="text-center" style="margin-left: -15px;">Danh Sách Bán Olive Collagen</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu hidden-xs">
                        ...
                        <li><a href="./gallery.php?view=olive-collagen" class="text-center" style="margin-left: 0px;">Olive Collagen</a></li>
